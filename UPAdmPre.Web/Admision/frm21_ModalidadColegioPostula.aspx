<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm21_ModalidadColegioPostula.aspx.cs" Inherits="UPAdmPre.Web.Admision.frm21_ModalidadColegioPostula" %>
        ...
        $("document").ready(function () {
            ...
            $("#txtColegio1").autocomplete({
                        ...
                        function (data) {
                            ...
                            response($.map(colegios, function (item) {
                                return {
                                    ...
                                    TipoEvaluacionECL: item.TipoEvaluacionECL /*Se agrega:Christian Ramirez - REQ110609*/
                                }
                            }))
                        } //,
                        //fnLlamadaError
                ...
                select: function (event, ui) {
                    ...
                    $("#hddColegio1TipoEvaluacionECL").val(ui.item.TipoEvaluacionECL); /*Se agrega:Christian Ramirez - REQ110609*/
...
<body>
    ...
    <form id="form1" runat="server">
                    ...
                    <td>
                                                        ...
                                                        <table style="width: 100%;" class="tablaFrame">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-top: 10px; width: 90%;">
                                                                    ...
                                                                    <asp:HiddenField runat="server" ID="hddColegio1TipoEvaluacionECL"/>
                                                                </td>
                                                                <td style="width: 1%;" class="requerido">
                                                                    <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/   .gif" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                        ...
                        <div class="adm-box">
                            <table style="width: 100%;">
                                        ...
                                        <table style="width: 100%;" class="tablaFrame">
                                            <tr>
                                                <td class="SubTitulo" colspan="6">
                                                    <table style="width: 100%;" class="tablaInterna">
                                                        <tr>
                                                            <td>
                                                                <label>Ingresa las cantidades de tus competencias</label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="6" style="padding-top:5px;">
                                                    ...
                                                    <span id="lblMensajeCantidadCompentenciaAD01" runat="server" style="color:red; font-size:13px; font-family: Tahoma;">
                                                        Campos obligatorios, si hay algún campo vacío se tomará 
                                                        como valor cero. 
                                                        <%--<b>Los postulantes por las modalidades de Admisión Pre Pacífico, Traslados y Graduados no deben de completar los siguientes campos:</b>--%>

                                                    </span>
                                                </td>
                                            </tr>
                                            <%--Ini:Christian Ramirez - REQ112736--%>
                                            <tr>
                                                <td colspan="6" style="padding:.5rem 0;">
                                                    <img src="../Images/ConversionVigesimal.png" />
                                                </td>
                                            </tr>
                                            <%--Fin:Christian Ramirez - REQ112736--%>
                                            <tr>
                                            ...
                                            <tr runat="server" id="trBtnEditarCompetencias">
                                                <td colspan="6">
                                                    ...
                                                    <span id="spMensajeBotonEditar" runat="server" style="color:red; font-size:11px; font-family: Tahoma; text-align: left">
                                ...
                                <tr id="trRendimiento" runat="server" style="display:none;">
                                    <td>
                                        <table style="width: 100%;" class="tablaFrame">
                                            <tr>
                                                <td class="SubTitulo" colspan="6">
                                            ...
                                            <tr>
                                                <td colspan="4" style="padding-top:5px;">
                                                    <asp:Image runat="server" ImageUrl="~/Images/ico_Required.gif" />
                                                    <span id="Span1" runat="server" style="color:red; font-size:13px; font-family: Tahoma;">
                                                        Campos obligatorios, si hay algún campo vacío se tomará 
                                                        como valor cero. 
                                                        <%--<b>Los postulantes por las modalidades de Admisión Pre Pacífico, Traslados y Graduados no deben de completar los siguientes campos:</b>--%>
                                                    </span>
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center">
                                                    <asp:TextBox ID="txtTipoNota3_Egresado" runat="server" CssClass="txtCajaTexto" Text="Numérico" Enabled="false" Width="100px"></asp:TextBox>
                                                </td >
                                                <td colspan="2" style="text-align: center">
                                                    <asp:TextBox ID="txtTipoNota4_Egresado" runat="server" CssClass="txtCajaTexto" Text="Numérico" Enabled="false" Width="100px"></asp:TextBox>
                                                </td>
                                                <td colspan="2" style="text-align: center">
                                                    <asp:TextBox ID="txtTipoNota5_Egresado" runat="server" CssClass="txtCajaTexto" Text="Numérico" Enabled="false" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtOrdenMeritoTercero" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtOrdenMeritoCuarto" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtOrdenMeritoQuinto" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalAlumnosTercero" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalAlumnosCuarto" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalAlumnosQuinto" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr runat="server" id="trBtnEditarRendimiento">
                                                <td colspan="6">
                                                    <asp:Button ID="btnEditarRendimiento" runat="server" Text="Editar" CssClass="btnLimpiar" OnClick="btnEditarRendimiento_Click"/>
                                                    <span id="Span3" runat="server" style="color:red; font-size:11px; font-family: Tahoma; text-align: left">
                                                       Para modificar las competencias, debe dar click en el botón "Editar"</span>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr id="trCompetenciasEstudiante" runat="server" style="display: none;">
                                    <td>
                                        <table style="width: 100%;" class="tablaFrame">
                                            <%--TITULO--%>
                                             <tr>
                                            ...
                                            <tr>
                                                <td colspan="5" style="padding-top: 5px;">
                                                    <asp:Image runat="server" ImageUrl="~/Images/ico_Required.gif" />
                                                    <span id="lblMensajeCantidadCompentenciaAD01Estudiante" runat="server" style="color: red; font-size: 13px; font-family: Tahoma;">
                                                        Campos obligatorios, si hay algún campo vacío se tomará como valor cero. 
                                                    </span>
                                                </td>
                                            </tr>
                                            <%--Ini:Christian Ramirez - REQ112736--%>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" style="text-align: center">
                                                    <asp:Label runat="server" Text="5to (Opcional)" CssClass="TextoEtiqueta"></asp:Label>
                                                </td>
                                            </tr>
                                            <%--TIPO NOTA--%>
                                            <tr>
                                                <td colspan="2" style="text-align: center; width: 33%;">
                                                    <asp:TextBox ID="txtTipoNota3Estudiante" runat="server" CssClass="txtCajaTexto" Text="Letras" Enabled="false" Width="100px"></asp:TextBox>
                                                </td>
                                                <td colspan="2" style="text-align: center; width: 33%;">
                                                    <asp:TextBox ID="txtTipoNota4Estudiante" runat="server" CssClass="txtCajaTexto" Text="Letras" Enabled="false" Width="100px"></asp:TextBox>
                                                </td>
                                                <td colspan="2" style="text-align: center; width: 33%;">
                                                    <asp:TextBox ID="txtTipoNota5Estudiante" runat="server" CssClass="txtCajaTexto" Text="Letras" Enabled="false" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <%--TIPO NOTA: AD--%>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalADTerceroEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                <td style="text-align: center;">
                                                    <asp:Label runat="server" Text="¿Cuántas (AD) obtuviste?" CssClass="TextoEtiqueta"></asp:Label>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalADCuartoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                <td style="text-align: center;">
                                                    <asp:Label runat="server" Text="¿Cuántas (AD) obtuviste?" CssClass="TextoEtiqueta"></asp:Label>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalADQuintoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <%--TIPO NOTA: A--%>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalATerceroEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalACuartoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtTotalAQuintoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <%--TIPO NOTA: B--%>
                                            <tr>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalBTerceroEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:Label runat="server" Text="¿Cuántas (B) obtuviste?" CssClass="TextoEtiqueta"></asp:Label>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalBCuartoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalBQuintoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <%--TIPO NOTA: C--%>
                                            <tr>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalCTerceroEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalCCuartoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalCQuintoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <%--TIPO NOTA: TOTAL--%>
                                            <tr>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalCompetenciasTerceroEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:Label runat="server" Text="¿Total de Competencias?" CssClass="TextoEtiqueta"></asp:Label>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalCompetenciasCuartoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:Label runat="server" Text="¿Total de Competencias?" CssClass="TextoEtiqueta"></asp:Label>
                                                ...
                                                <td style="padding-left: 0px">
                                                    <asp:TextBox ID="txtTotalCompetenciasQuintoEstudiante" runat="server" CssClass="txtCajaTexto" MaxLength="3" Text="0"
                                                        placeholder="Digite valor numérico" onkeypress="return soloNumeros(this);" Width="100px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <%--BOTON EDITAR--%>
                                            <tr runat="server" id="trBtnEditarCompetenciasEstudiante">
                                                <td colspan="6">
                                                    <asp:Button ID="btnEditarCantidadCompetenciaEstudiante" runat="server" Text="Editar" CssClass="btnLimpiar"
                                                        OnClick="btnEditarCantidadCompetenciaEstudiante_Click" />
                                                    <span id="spMensajeBotonEditarEstudiante" runat="server" style="color: red; font-size: 11px; font-family: Tahoma; text-align: left">
                                                        Para modificar las competencias, debe dar click en el botón "Editar"</span>
                                                </td>
                                            </tr>
                                        </table>
                                                                            ...
                                                                            <table id="trModadlidadPostulacion" runat="server" class="tablaFrame"  style="display:none;">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="auto-style5" style="text-align: left; vertical-align: middle;">
                                                                                        ...
                                                                                        <span runat="server" id="spnModalidadAviso" style="color:red; font-size:11px; font-family: Tahoma;"></span>
                                                                                        ...
                                                                                        <asp:Label Visible="false" ID="lblTextCondAcademica" runat="server" CssClass="TextoEtiqueta" Text="Selecciona Condición académica:"></asp:Label>
                                                                                        <span runat="server" id="Span2" style="color:red; font-size:11px; font-family: Tahoma;"></span>
                                                                                        <asp:RadioButtonList ID="rblCondAcademica" runat="server" AutoPostBack="true" CssClass="radioButtonList" 
                                                                                            >
                                                                                        </asp:RadioButtonList>
                                                                                        <asp:Label ID="lblMsjeCondAcademic" runat="server" CssClass="tdTextoDetalles" ForeColor="Red"></asp:Label>
                                                                                    </td>
		...
		<%--Fin:Chritian Ramirez - REQ91569--%>
        <div>
            <ajax:ModalPopupExtender ID="mpeNoModalidad" runat="server" TargetControlID="main" BackgroundCssClass="modalBackground"
                CancelControlID="btnCerrarPopuAviso" PopupControlID="divPopupAvisoNoModalidad" Enabled="True"/>
            <div id="divPopupAvisoNoModalidad">
                <div class="popup-main">
                    <div class="popup-header" style="background-color: #2a7cba">
                        <h4>¡Aviso!</h4>
                    </div>
                    <div class="popup-content">
                        <p><asp:Label runat="server" ID="txtAviso">No cumple con rendimiento académico por favor revisar prospecto de admisión.</asp:Label></p>
                    </div>
                    <div class="popup-footer">
                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnCerrarPopuAviso_Click">Cerrar</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
